<template>
	<div class="home flex flex_row font_0 p_4">
		...
		<section class="flex_column flex flex_auto p_5">
			<header class="flex flex_row font_1">
				<BreadCrumb v-bind="navData" />
			</header>
			<main>
				<div class="w_100">
					<div class="flex flex_row">
						<h1 class="font_5 c_black-9 p-t_4 flex_auto text_left">Program</h1>
					...
					<div class="flex flex_row p-y_3 w_100"><SearchBar class="w_100" /></div>
